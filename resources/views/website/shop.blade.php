                                        ...
                                        @foreach ($showCategories as $category)
                                            <a href="{{ route('selected.products', $category->id) }}">
                                                <li class="list-item">
                                                    ...
                                                    <span
                                                        class="text-secondary">{{ $category->SubCategory()->count() }}</span>
                                                </li>
                                            </a>
                                        @endforeach
                                    </ul>
                                ...
                                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                    <div class="pc__img-wrapper">
                                        <div class="swiper-container background-img js-swiper-slider"
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <a href="{{ route('prodcuts.details', $product->id) }}"><img
                                                            loading="lazy"
                                        ...
                                        {{-- <form action="{{ route('add.cart') }}" method="post">
                                            ...
                                            <button type="submit"
                                                class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside">Add To Cart</button>
                                        </form> --}}
                                    </div>
