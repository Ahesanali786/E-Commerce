...
@section('title', 'Product Shoping page')
{{--
                        ...
                        <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="accordion-body px-0 pb-0 pt-3">
                                <ul class="list list-inline mb-0">
                                    ...
                                    <a href="{{ route('selected.products', $category->id) }}">
                                        <li class="list-item">
                                            <span class="me-auto" active>{{ $category->name }}</span>
                                            <span class="text-secondary">{{ $category->SubCategory()->count() }}</span>
                                        </li>
                                    </a>
                                    @endforeach
                                </ul>
                        ...
                        <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                ...
                                <ul class="multi-select__list list-unstyled">
                                    @foreach ($showSubCategories as $sub)
                                    <a href="{{ route('subCategories.product', $sub->id) }}">
                                        <li class="search-suggestion__item multi-select__item text-primary">
                                            <span class="me-auto">{{ $sub->name }}</span>
                                            <span class="text-secondary">{{ $sub->Products()->count() }}</span>
                                        </li>
                                    </a>
                                    @endforeach
                                </ul>
                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                ...
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy" src="{{ asset('website/images/shop/shop_banner3.jpg') }}"
                        ...
                        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider"
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            ...
                                            @endphp
                                            <a href="{{ route('prodcuts.details', ['product_id' => $productId]) }}"><img
                                                    loading="lazy" src="{{ asset('Product_image/' . $product->image) }}"
                                ...
                                {{-- <form action="{{ route('add.cart') }}" method="post">
                                    ...
                                    <button type="submit"
                                        class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside">Add
                                        To Cart</button>
                                </form> --}}
                            </div>
                                ...
                                <div class="product-card__review d-flex align-items-center">
                                    <div class="reviews-group">
                                        <div>
                                            ...
                                            // Determine if a half star should be displayed based on the decimal part of
                                            // the average rating
                ...
                <nav class="shop-pages d-flex justify-content-between mt-3" aria-label="Page navigation">
                    ...
                    <ul class="pagination mb-0">
                        @for ($i = 1; $i <= $products->lastPage(); $i++)
                            <li class="page-item">
                                <a class="btn-link px-1 mx-2 {{ $products->currentPage() == $i ? 'btn-link_active' : '' }}"
                                    href="{{ $products->url($i) }}">
                                    {{ $i }}
                                </a>
                            </li>
