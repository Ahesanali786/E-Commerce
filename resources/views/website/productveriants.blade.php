...
@section('title', 'Products-Variants-details')
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" class="h-auto"
                                        src="{{ asset('Product_image/' . $variants->product->image) }}" width="674"
                                        height="674" alt="{{ $variants->product->name }}" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                        src="{{ asset('Product_image/' . $variants->product->image) }}" width="104"
                                        height="104" alt="{{ $variants->product->name }}" /></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5">
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <a href="{{ URL::to('products/details/' . $previous) }}" class="text-uppercase fw-medium"><svg
                ...
                <h1 class="product-single__name">{{ $variants->product->name }}</h1>
                ...
                <div class="product-single__price">
                    ...
                    <span class="current-price">{{ $variants->Price ?? $variants->product->price }}</span>
                </div>
                <div class="product-single__short-desc">
                    ...
                    <h4 class="variants-title">Current Variants:</h4>
                    <ul class="variants-list">
                        <li class="variant-item">
                            <span class="variant-name">{{ $variants->attribute->variant_name }}</span>
                            <span class="variant-value">{{ $variants->variant_value }}</span>
                        </li>
                    </ul>
                </div>
                ...
                <form action="{{ route('add.cart') }}" method="post">
                    ...
                    <div class="product-single__addtocart">
                        ...
                        <input type="hidden" name="product_id" value="{{ $variants->product->id }}">
                ...
                <div class="product-single__meta-info">
                    <div class="meta-item">
                        ...
                        <span>{{ $variants->product->subCategory->name }}</span>
                    </div>
                    <div class="meta-item">
                        <label>Categories:</label>
                        <span>{{ $variants->product->subCategory->Category->name }}</span>
                    </div>
                    <div class="meta-item">
                        <label>Tags:</label>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tab-description" role="tabpanel"
                    ...
                    <div class="product-single__description">
                        <h3 class="block-title mb-4">{{ $variants->product->description }}</p>
                            <div class="row">
                                <div class="col-lg-6">
